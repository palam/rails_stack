...
wget --no-check-certificate -O /etc/ssh/sshd_config $templates_url/ssh_config
...
wget --no-check-certificate -O /etc/iptables.up.rules $templates_url/iptables.up.rules
