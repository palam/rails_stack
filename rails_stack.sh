...
wget -O --no-check-certificate /etc/ssh/sshd_config $templates_url/ssh_config
...
wget -O --no-check-certificate /etc/iptables.up.rules $templates_url/iptables.up.rules
